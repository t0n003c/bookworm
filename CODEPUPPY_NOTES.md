...
> Last recorded session: **2026-05-25** (Push notification full audit — 4 bugs fixed across widget/bud loops; CRM push race condition fixed; PWA reinstall subscription-loss identified as root cause).
