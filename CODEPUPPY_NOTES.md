...
> Last recorded session: **2026-05-25** (Grid thumbnail perf fix + CRM Address field + CRM Reminder custom field type + Nominatim address autocomplete + address format cleanup).
