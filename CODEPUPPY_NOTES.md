...
> Last recorded session: **2026-06-02** (Hybrid Search Q&A Phase 2 shipped — TF-IDF hybrid pipeline + APScheduler nightly rebuild).
...
> **🔜 Phase 3 is next:** LLM streaming Q&A via `search_llm.py` — OpenAI-compatible endpoint, configurable in `site_settings`.
>
