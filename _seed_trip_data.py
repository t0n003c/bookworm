...
panels = [
    ...
    (
        ...
        json.dumps({
            ...
            "currency": "USD",
            "items": [
                {"label": "Flights (round trip)",  "amount": 800,  "category": "Other",           "note": "Book 3-4 months out"},
                {"label": "Hotel — Le Marais (4n)","amount": 1120, "category": "Hotel",           "note": "~$280/night"},
                {"label": "Food & Drink",           "amount": 400,  "category": "Restaurant",      "note": "Mix of bistros + markets"},
                {"label": "Attractions",             "amount": 120,  "category": "City Attraction", "note": "Eiffel, Louvre, Versailles"},
                {"label": "Transport (Paris)",       "amount": 50,   "category": "Other",           "note": "Navigo Semaine pass"},
                {"label": "Misc / Shopping",         "amount": 200,  "category": "Other",           "note": ""},
            ],
        }),
        10,
    ),
    ...
    (
        ...
        json.dumps({
            ...
            "currency": "USD",
            "items": [
                {"label": "Flights (round trip)",        "amount": 900,  "category": "Other",           "note": "Book 4-6 months out for sakura season"},
                {"label": "JR Pass (7-day)",              "amount": 350,  "category": "Other",           "note": "Buy before leaving the US!"},
                {"label": "Ryokan Hiiragiya (3n)",        "amount": 1350, "category": "Hotel",           "note": "Includes kaiseki dinner + breakfast"},
                {"label": "Tokyo hotel (4n)",             "amount": 600,  "category": "Hotel",           "note": "~$150/night"},
                {"label": "Food & Drink",                 "amount": 500,  "category": "Restaurant",      "note": "Mix of ramen, izakaya, one fancy dinner"},
                {"label": "Attractions & Entrance Fees",  "amount": 80,   "category": "City Attraction", "note": "Kinkaku-ji, tea ceremony, etc."},
                {"label": "IC Card / Local Transport",    "amount": 80,   "category": "Other",           "note": "Osaka day trip + Suica loads"},
                {"label": "Shopping / Souvenirs",         "amount": 300,  "category": "Other",           "note": "Matcha kits, ceramics, snacks"},
            ],
        }),
        10,
    ),
