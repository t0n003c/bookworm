...
function _buildCatalogTreeHtml(parentKey, depth, byParent) {
  ...
  children.forEach(function(c) {
    ...
    // Skip hidden catalogs entirely unless manage-mode is active or the catalog is currently selected
    if (isHidden && !(typeof _uplFldHideMode !== 'undefined' && _uplFldHideMode) && !isActive) return;
